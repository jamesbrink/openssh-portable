...
#define CKM_SSL3_PRE_PRIMARY_KEY_GEN	(0x370)
#define CKM_SSL3_PRIMARY_KEY_DERIVE	(0x371)
#define CKM_SSL3_KEY_AND_MAC_DERIVE	(0x372)
#define CKM_SSL3_PRIMARY_KEY_DERIVE_DH	(0x373)
#define CKM_TLS_PRE_PRIMARY_KEY_GEN	(0x374)
#define CKM_TLS_PRIMARY_KEY_DERIVE	(0x375)
#define CKM_TLS_KEY_AND_MAC_DERIVE	(0x376)
#define CKM_TLS_PRIMARY_KEY_DERIVE_DH	(0x377)
